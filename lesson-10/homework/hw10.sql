...
SELECT 
	c.FirstName, c.LastName, Count(o.OrderID) as TotalOrders
FROM Customers C
JOIN Orders o on c.CustomerID = o.CustomerID
...
SELECT 
	e1.Name as EmployeeName1,e2.Name as EmployeeName2 , e1.ManagerID
FROM Employees e1
...
SELECT 
	e.Name as EmployeeName , e.Salary, d.DepartmentName
FROM Employees e
JOIN Departments d on e.DepartmentID = d.DepartmentID
...
SELECT 
	o.OrderID, o.OrderDate, p.PaymentID, p.Amount 
FROM Orders o 
join Payments p on o.OrderID = o.OrderID;
