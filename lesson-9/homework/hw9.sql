...
SELECT O.OrderID, o.CustomerID, p.ProductName, p.Price
FROM Orders o 
...
SELECT e1.EmployeeID AS ManagerID, e1.Name AS ManagerName, 
       e2.EmployeeID AS EmployeeID, e2.Name AS EmployeeName,
       e1.Salary AS ManagerSalary, e2.Salary AS EmployeeSalary
FROM Employees e1
